        ...
        for i in range(n_shakes-1):
            ...
            for name,modu in new_module.named_modules():
                if isinstance(modu, nn.Conv2d) or\
                    ...
                    nn.init.xavier_uniform_(modu.weight)
...
class GlobalAvgPool(nn.Module):
    """
    Performs a global average pooling over the spatial dimensions of
    the inputs.
    """
    def forward(self, x):
        """
        Averages over the last 2 dimensions of x
